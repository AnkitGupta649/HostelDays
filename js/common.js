window.addEventListener("load", function () {
    ...
    var listingyourproperty = document.getElementById("listingproperty");
    listingyourproperty.addEventListener("submit", function (event) {
        var XHR = new XMLHttpRequest();
        var form_data = new FormData(listingyourproperty);
        ...
        // Set up request
        XHR.open("POST", "api/list_property.php");
